...
type Props = { engine: AiEngine; size?: number; className?: string; title?: string };

export function EngineLogo({ engine, size = 20, className, title }: Props) {
  const label = title ?? ENGINE_LABEL[engine];
  switch (engine) {
    case "chatgpt":
      return (
        <svg width={size} height={size} viewBox="0 0 256 260" role="img" aria-label={label} className={cn("shrink-0", "text-foreground", className)}>
          <title>{label}</title>
    ...
    case "claude":
      return (
        <svg width={size} height={size} viewBox="0 0 256 257" role="img" aria-label={label} className={cn("shrink-0", className)}>
          <title>{label}</title>
    ...
    case "google_aio":
      return (
        <svg width={size} height={size} viewBox="0 0 256 262" role="img" aria-label={label} className={cn("shrink-0", className)}>
          <title>{label}</title>
